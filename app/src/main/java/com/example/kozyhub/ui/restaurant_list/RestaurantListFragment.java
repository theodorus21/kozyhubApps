package com.example.kozyhub.ui.restaurant_list;
...
public class RestaurantListFragment extends ProductListFragment {
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        this.destinationAction = R.id.action_restaurantListFragment_to_productDetailFragment;
