...
public class Catering extends Category implements Parcelable {
    ...
    public Catering(int pkBranch, String branchName, String branchDesc, String branchPhone1, String branchPhone2, String description, String pict1, String pict2, String pict3, String pict4, String pict5, String pict6) {
        PkBranch = pkBranch;
